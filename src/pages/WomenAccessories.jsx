...
import { womenAccessoriesData, womenAccessoriesFilterMeta } from '../data/womenAccessoriesData';
...
const WomenAccessories = () => {
  ...
  const maxPrice = useMemo(() => Math.max(...womenAccessoriesData.map((item) => item.price)), []);
  ...
  const filteredProducts = useMemo(() => {
    return womenAccessoriesData.filter((product) => {
  ...
  return (
    <section className="women-accessories-page">
      <div className="accessories-banner">
        <div className="container accessories-banner-content">
          <div>
            <p className="banner-breadcrumb">Women / Accessories</p>
            <h1>Women Accessories</h1>
            <p className="banner-subtitle">Jewellery, Bags, Watches, Footwear & More</p>
          </div>
          <span className="offer-badge">Up to 50% Off</span>
        </div>
      </div>

      <div className="container accessories-content-wrap">
        <FilterSidebar
          filters={filters}
          filterMeta={womenAccessoriesFilterMeta}
          maxPrice={maxPrice}
        ...
        <div className="accessories-main-content">
          ...
          {loading ? (
            ...
            <div className="empty-state">
              <h3>No accessories matched your filters</h3>
